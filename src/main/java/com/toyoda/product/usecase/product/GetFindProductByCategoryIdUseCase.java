...
public class GetFindProductByCategoryIdUseCase {

    private final ProductService service;
    private final ProductMapper mapper;

    public List<ProductDto> execute(Integer categoryId) {
        List<Product> products = service.findProductByCategory(categoryId).orElseThrow(() -> new ProductNotFoundException("Products not found"));
